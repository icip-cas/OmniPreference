...
def run(args):
    ...
    output_json = os.path.join(args.output_dir, f"{model_name}-CMM-video-driven-results.json")
    ...
    output_pt = os.path.join(
        args.output_dir,
        f"{model_name}-CMM-video-driven-hiddenstates.pt"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Path to CMM video-driven json file",
    )
    parser.add_argument(
        "--model_path",
