...
def run(args):
    ...
    output_json = os.path.join(args.output_dir, f"{model_name}-CMM-audio-driven-results.json")
    ...
    output_pt = os.path.join(
        args.output_dir,
        f"{model_name}-CMM-audio-driven-hiddenstates.pt"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Path to CMM audio-driven json file",
    )
    parser.add_argument(
        "--model_path",
