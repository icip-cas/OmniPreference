...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_file", default='conflict_triplets1000_processed.json', help="Path to conflict triplets JSON file")
    parser.add_argument("--output_dir", default='results', help="Directory to save results")
    parser.add_argument("--model_name", default="google/gemini-2.5-flash")
    parser.add_argument("--api_key", default='', help="OpenRouter API key (or set OPENROUTER_API_KEY env var)")
